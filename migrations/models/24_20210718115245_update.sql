...
CREATE TABLE IF NOT EXISTS "collectionentry" (
    ...
    CONSTRAINT "uid_collectione_user_id_f5c869" UNIQUE ("user_id", "server_id", "gacha_id", "table_rate_id", "card_id")
);
...
CREATE TABLE IF NOT EXISTS "gachastate" (
    ...
    CONSTRAINT "uid_gachastate_user_id_874d97" UNIQUE ("user_id", "server_id", "gacha_id")
);;
-- downgrade --
